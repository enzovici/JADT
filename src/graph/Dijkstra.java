...
public class Dijkstra<V , E> {
  ...
  protected Object WEIGHT; // qui il peso di un arco è un attributo
  /** Decoration key for vertex distances  */
  protected Object DIST = new Object(); // distanza finale
 ...
 protected void dijkstraVisit (Vertex<V> v) {
		   ...
		   for (Vertex<V> u: graph.vertices()) {
			...
			u_dist = INFINITE;
		     ...
		     u.put(ENTRY, u_entry);//attscca l'attributo entry al vertice
		   }
